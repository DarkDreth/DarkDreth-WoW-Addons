...
L["DESCRIPTION"] = "Les soigneurs doivent mourir comme tout le monde, c'est une réalité de WoW. Cet Add-on vous aide à influencer ce funeste destin d'une façon ou d'une autre selon l’allégeance du soigneur..."
...
L["OPT_STRICTGUIDPVE_DESC"] = "Quand plusieurs PNJ partagent le même nom, HHTD n'ajoutera une croix qu'à ceux qui ont réellement soigné au lieu d'en ajouter une à tous. Notez qu'il vous faudra cibler ou survoler les unités avec la souris pour que les croix apparaissent." -- Needs review
...
L["DESCRIPTION"] = "Heiler müssen sterben wie jeder andere auch, dies ist Fakt in WoW . Dieses Addon hilft ihnen, dieses bedauerliche Schicksal der Heiler auf dem einen oder anderen Weg, in Abhängigkeit davon auf welcher Seite der Heiler steht, zu beeinflussen" -- Needs review
...
L["OPT_STRICTGUIDPVE_DESC"] = "Cuando varios NPCs compartan el mismo nombre, HHTD solo añadirá una cruz sobre aquellos que realmente curaron en vez de a todos. Toma nota de que la mayor parte del tiempo, necesitarás seleccionar o pasar el ratón por encima para que aparezca la cruz." -- Needs review
...
L["DESCRIPTION"] = "피의 힐러를 빠르게 발견하고 그들의 운명을 결정짓습니다! (PVP 와 PVE)" -- Needs review
...
L["OPT_STRICTGUIDPVE_DESC"] = "여러 NPC가 같은 이름을 가지고 있으면 HHTD는 그들 모두에게 십자가를 표시하는 대신 실제로 치유하는 NPC에게만 십자가를 표시합니다. 지속적으로 십자가를 표시할 유닛을 대상 지정하거나 마우스-오버를 해야 한다는 걸 기억하세요." -- Needs review
...
L["OPT_STRICTGUIDPVE_DESC"] = "当多个 NPC 共享相同的名称，HHTD 只会增加一个十字而不是全部。请注意，在十字出现之前大部分的时间需要切换目标或鼠标悬停在单位。" -- Needs review
...
L["DESCRIPTION"] = "讓那些強大的補師立馬現形，並且幫助他們完成自己的使命! (PVP 和 PVE)" -- Needs review
L["DISABLED"] = [=[hhtd 已被禁用！
輸入“/hhtd on”來重新啟用。]=]
...
L["OPT_STRICTGUIDPVE_DESC"] = "當幾個NPC共享相同的名稱時，HHTD將只會增加一個紅十字在真實的治療者上，而不是所有人。請注意大多數時間，你需要指定目標或滑鼠停留一個單位以便讓十字顯示。" -- Needs review
...
-- L["CM"] = ""
-- L["CM_DESC"] = ""
L["DESCRIPTION"] = "Мгновенно обнаружить этих чертовых лекарей и воздать им по заслугам! (PVP и PVE)." -- Needs review
...
L["OPT_STRICTGUIDPVE_DESC"] = "Если несколько НИП имеют одинаковые имена, HHTD добавит красный крест только к тому, который лечил в последнее время, а не ко всем сразу. В большинстве случаев понадобится выбрать НИП целью или навести на него мышь для появления креста." -- Needs review
...
-- L["CM"] = ""
-- L["CM_DESC"] = ""
L["DESCRIPTION"] = "Individua quei dannati curatori all'istante e aiutali a compiere il loro destino! (PVP e PVE)" -- Needs review
...
L["OPT_STRICTGUIDPVE_DESC"] = "Quando più NPC condividono lo stesso nome, HHTD aggiungerà una croce solo sopra a quelli che effettivamente avranno curato invece che a tutti loro. Nota che il più delle volte avrai bisogno di prendere in target o passare il mouse su di un'unità prima che la croce appaia." -- Needs review
